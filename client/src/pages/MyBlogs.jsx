      ...
      {loading ? (
        ...
        <div className="min-h-125 bg-gray-100 px-6 py-8 gap-4 flex-wrap flex">
          ...
          {blogs.length === 0 ? (
            ...
            <Link
              to={"/post"}
              className="w-160  bg-white p-6 rounded shadow-md flex justify-center items-center text-5xl text-black/50 hover:bg-teal-700 hover:text-white transition duration-200"
            >
              <FaPlus />
            </Link>
          )}
